...
install -Dm644 packaging/arch-bin/ai-leash-bin.install "$out/ai-leash-bin.install"
install -Dm644 "$workdir/extracted/usr/share/icons/hicolor/32x32/apps/ai-leash.png" "$out/ai-leash-32.png"
install -Dm644 "$workdir/extracted/usr/share/icons/hicolor/64x64/apps/ai-leash.png" "$out/ai-leash-64.png"
