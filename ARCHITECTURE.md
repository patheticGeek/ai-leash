...
| `SidePanel.tsx`                                                                  | Multi-tab right panel: file tree, per-file editors, terminals, Sub Agents list, Actions list, per-Action terminal — all keyed/deduped/mounted per the rules in `store/panelSlice.ts`.                                                                                                            |
