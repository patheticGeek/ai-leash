...
const tabsTriggerVariants = cva(
  [
    ...
    "data-active:bg-border data-active:text-zinc-100 data-active:hover:bg-border data-active:hover:text-zinc-100",
  ...
  ],
  {
    variants: {
      variant: {
        default: "",
        line: "bg-transparent data-active:bg-transparent data-active:hover:bg-transparent data-active:border-transparent",
        strip:
          "h-auto flex-none px-2 py-1.5 text-xs font-normal text-zinc-500 duration-150 ease-out hover:bg-transparent hover:text-zinc-300 data-active:bg-white/10 data-active:text-zinc-100 data-active:hover:bg-white/10 data-active:hover:text-zinc-100",
      },
      size: {
        sm: "",
        md: "px-2.5 py-1.5",
