  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[size=md]/tabs-list:px-2.5 group-data-[size=md]/tabs-list:py-1.5",
        "group-data-[size=lg]/tabs-list:px-3 group-data-[size=lg]/tabs-list:py-2 group-data-[size=lg]/tabs-list:text-base group-data-[size=lg]/tabs-list:[&_svg:not([class*='size-'])]:size-5",
