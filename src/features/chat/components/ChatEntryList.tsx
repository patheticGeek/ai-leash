          ...
          >
            ...
            {acpHistoryTruncated && (
              <div className="sticky top-1 rounded-md shadow-[0_0_0_1px_rgba(120,53,15,0.5)] bg-amber-950/30 px-3 py-2 text-amber-300 text-xs">
                {acpAgentLabel ?? "This agent"} doesn't support resuming a
                previous session, so this conversation's earlier history won't
                be visible to it.
              </div>
            )}
            {systemPrompt && (
              ...
              <div className="flex min-h-[min(28rem,60vh)] items-center justify-center px-4">
                <div className="w-full max-w-md text-center">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-500">
                    Ask about your code, plan a change, or let the agent explore
